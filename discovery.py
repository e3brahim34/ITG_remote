        ...
        try:
            ...
            while self.broadcasting:
                try:
                    ...
                    self.broadcast_socket.sendto(message, ('192.168.8.255', self.DISCOVERY_PORT))
        ...
        try:
            ...
            while self.listening:
                try:
                    ...
                    print(f"!!! DISCOVERY RECEIVED: {data.decode()} FROM {addr}")
                    print(f"DEBUG: Received packet from {addr}") # أضف هذا السطر
